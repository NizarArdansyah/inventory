...
<div class="">
    <div class="flex justify-between">
        <div class="flex items-center gap-2 mb-4">
            <h2 class="text-2xl font-bold ">Kelola Barang</h2>
            <a href='/barang/create'>+</a>
        </div>
        <div class="relative">
    ...
    <div class="rounded-lg border border-gray-200">
        <div class="overflow-x-auto rounded-t-lg">
            ...
            <thead class="text-left">
                ...
                <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Harga Beli</th>
            ...
            <tbody class="divide-y divide-gray-200"> 
                ...
                <?php foreach ($data as $b) : ?>
                    <tr>
                        ...
                        <td class="whitespace nowrap px-4 py-2 text-gray-700"><?= formatRupiah($b['harga_beli']) ?></td>
                        <td class="whitespace nowrap px-4 py-2 text-gray-700"><?= formatRupiah($b['harga_jual']) ?> </td>
                        <td class="whitespace nowrap px-4 py-2 text-gray-700"><?= $b['stok'] ?></td>
                        <td class="inline-flex overflow-hidden rounded-md border bg-white shadow-sm">
                            <a
                            class="inline-block border-e p-3 text-gray-700 hover:bg-gray-50 focus:relative"
                            title="Edit Product"
                            href="/barang/edit/<?= $b['id_barang'] ?>"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
