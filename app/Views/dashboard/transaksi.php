...
<div class="">
    ...
    <div class="rounded-lg border border-gray-200">
        <div class="overflow-x-auto rounded-t-lg">
            ...
            <thead class="text-left">
                ...
                <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Kuantitas</th>
                <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Kasir</th>
                <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Tanggal Transaksi</th>
            ...
            <tbody class="divide-y divide-gray-200"> 
                ...
                <?php foreach ($data as $b) : ?>
                    <tr>
                        ...
                        <td class="whitespace nowrap px-4 py-2 text-gray-700"><?= $b['fullname'] ?></td>
                        <td class="whitespace nowrap px-4 py-2 text-gray-700"><?= formatTanggal($b['tanggal_transaksi']) ?></td>
                        ...
                        <td class="inline-flex overflow-hidden rounded-md border bg-white shadow-sm">
                            ...
                            title="Edit Product"
                            href="/transaksi/edit/<?= $b['id_barang'] ?>"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
    ...
    <div class="mt-4">
        <h2 class="text-2xl font-bold">Total Transaksi: <?= formatRupiah($total) ?></h2>
