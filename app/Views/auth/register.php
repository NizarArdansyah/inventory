...
<div class="flex flex-col justify-center items-center h-screen">
    ...
    <form action="/auth/actregister" method="POST" class="max-w-[500px] w-full">
        <div class="relative flex items-center">
            <label for="Fullname" class="text-gray sr-only"> Fullname</label>
            <input
                required
                name="fullname"
                type="text"
                id="Fullname"
                placeholder="Flea Septiani"
        ...
        <div class="relative flex items-center">
            <label for="Username" class="text-gray sr-only"> Username</label>
            <input
                required
                name="username"
                type="text"
        ...
        <div class="flex w-full justify-between mt-4">
            ...
            <a href="/auth/login" class="text-gray-800 inline">Log In</a>
        </div>
    </form>
</div>
